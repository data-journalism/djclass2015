...
curve(f,0,2)
polygon(c(1.2,1.8,1.5,1.2),c(0,0,0.2,0.2))
a <- 1:10
b <- 1:15
...
p = ggplot(mtcars, aes(x = hp, y = mpg))+geom_point(size = 3)
p
p = ggplot(mtcars, aes(x = hp, y = mpg))+geom_point( size = 3) + stat_smooth(method = 'loess')
p
